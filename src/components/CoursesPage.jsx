            ...
            <div className="max-w-7xl mx-auto px-4">
                    ...
                    {filteredCourses.length === 0 ? (
                        <div className="text-center py-12">
                            ...
                            <button
                                ...
                                className="mt-4 bg-[#4CBC9A] text-white px-6 py-2 rounded-lg hover:bg-[#3aa384] transition"
                            >
                                Clear All Filters
                            </button>
                        </div>
                ...
                <div className="mt-16 bg-gradient-to-r from-[#6c5dd3] to-[#4CBC9A] rounded-2xl p-8 text-center text-white">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <button className="bg-white text-[#6c5dd3] px-6 py-3 rounded-lg font-semibold hover:bg-gray-100 transition">
