                ...
                <div key={course.id} className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                    ...
                    <div className="p-4">
                        ...
                        <div className="flex items-center gap-3 mb-3">
                            <div className="w-8 h-8 bg-[#4CBC9A] rounded-full flex items-center justify-center text-white text-sm font-semibold">
                        ...
                        <Link
                            to={`/course/${course.id}`}
                            className="w-full bg-[#6c5dd3] text-white py-2 px-4 rounded-lg hover:bg-[#5a4bbf] transition text-center block font-medium"
                        >
