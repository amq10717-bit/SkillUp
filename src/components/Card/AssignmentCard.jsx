    ...
    return (
        <div className="group relative p-6 bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300 border-l-4 border-hoverGreen hover:border-hoverYellow">
            <div className="flex justify-between items-start mb-4">
                ...
                <span className="text-sm text-gray-500 min-w-max ml-2">
                    {deadline}
                </span>
            </div>
            ...
            <div className="flex items-center justify-between border-t pt-4">
                ...
                <Link
                    ...
                    className="px-4 py-2 bg-BgPrimary hover:bg-green-700 text-white rounded-lg text-sm font-medium transition-colors duration-200 transform hover:-translate-y-0.5 hover:shadow-lg"
                >
